...
export const insertNode = async (
  ...
  while (
    ...
    // Ensure the `left` and `right` child assignments are correct THIS NEEDS FIXING
    ...
    // Update the nodes' positions on the tree visualization I THINK THIS ALSO NEEDS FIXING
